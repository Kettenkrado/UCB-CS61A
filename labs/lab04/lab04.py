def divide(quotients, divisors):
    ...
    """
    return {quotient: [x for x in divisors if x % quotient == 0] for quotient in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a = distance(city_a, given_city)
    distance_b = distance(city_b, given_city)
