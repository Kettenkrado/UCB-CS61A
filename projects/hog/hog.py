...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            score = score1
        score_increse = score - last_score
        if score_increse > running_high:
            score_increse = score - last_score
            print(score_increse, 'point(s)! The most yet for Player', who)
            return announce_highest(who, score, score_increse)
        else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    i, times, highest = 1, 1, 1
    while i <= 10:
        this_time = make_averaged(roll_dice, trials_count)(i, dice)
        if this_time > highest:
            times = i
            highest = this_time
        i += 1
    return times
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if extra_turn(free_bacon(opponent_score) + score, opponent_score) or free_bacon(opponent_score) >= cutoff else num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    if score < 90:
        return extra_turn_strategy(score, opponent_score, 9, 6)
    elif score < 95:
        return 3
    else:
        return 0
